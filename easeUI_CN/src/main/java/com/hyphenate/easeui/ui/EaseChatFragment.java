...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector,
            R.drawable.ease_chat_image_selector, R.drawable.ease_chat_call_selector};
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatUsernike = fragmentArgs.getString("to_user_nike");
        toChatUserpic = fragmentArgs.getString("to_user_pic");
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (listView.getFirstVisiblePosition() == 0 && !isloading && haveMoreData) {
                            ...
                            showToast(getResources().getString(R.string.no_more_messages));
                        }
                        swipeRefreshLayout.setRefreshing(false);
                    }
                }, 600);
...
//                            titleBar.setTitle(toChatUsername);
   ...
   /* MessageReceivedInter messageReceivedInter;
   public void  setMessageReceivedInter( MessageReceivedInter messageReceivedInter){
        this.messageReceivedInter=messageReceivedInter;
    }

    public interface MessageReceivedInter{
        void getReceivedMessage(String conversationId,String nickname,String avatarURL);
    }*/
...
//            }
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener {
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_VOICECALL:
                    //拨打语音电话
                    LogUtils.e("username:" + toChatUsername + ",nike" + toChatUsernike + ",meUsername:" + userName + ",meUserPortrait:" + userPic);
                    startActivity(new Intent(getContext(), VoiceCallActivity.class)
                            .putExtra("username", toChatUsername)
                            .putExtra("nike", toChatUsernike)
                            .putExtra("meUsername", userName)
                            .putExtra("meUserPortrait", userPic)
    ...
    protected void sendMessage(EMMessage message) {
        ...
        LogUtils.e("avatarURL->" + userPic);

        FriendsInfoCacheSvc.getInstance(getContext()).addOrUpdateFriends(new Friends(toChatUsername,
                toChatUsernike, toChatUserpic));
//        UserApiModel apiModel = UserInfoCacheSvc.getByChatUserName(getContext(), toChatUsername);
//        if (null!=apiModel) {
//            //保存对方的  toChatUsernike toChatUserpic
//            boolean orUpdate = UserInfoCacheSvc.createOrUpdate(getContext(), toChatUsername,
//                    toChatUsernike, toChatUserpic);
//            if (orUpdate) {
//                LogUtils.e("保存对方" + toChatUsername + "的信息成功");
//            }
//        }
