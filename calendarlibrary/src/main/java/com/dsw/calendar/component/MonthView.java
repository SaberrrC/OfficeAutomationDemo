...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attrs) {
        ...
        Log.e("calendar","MonthView->"+"currYear:"+currYear+",currMonth:"+currMonth+",currDay:"+currDay);
...
//        baseRowSize = rowSize = theme == null ? 70 : theme.dateHeight();
        baseRowSize = rowSize = theme == null ? 120 : theme.dateHeight();
...
//                    smoothScrollTo(moveX, 0);
    ...
    protected void setSelectDate(int year,int month,int day){
        Log.e("calendar","setSelectDate:selDay:"+selDay);
        selYear = year;
        selMonth = month;
        selDay = day;
    }
    ...
    private void doClickAction(int x,int y){
        ...
        Log.e("calendar","doClickAction:daysString[row][column]:"+daysString[row][column]);
    ...
    private void setLeftDate(){
        ...
        if(month == 0){//若果是1月份，则变成12月份
            ...
            month = month-1;
            //TODO Tsui2017-04-01注释的。为了解决3月份绘制日期问题
//            day = DateUtils.getMonthDays(year, month);
            Log.e("calendar","setLeftDate->向左滑动，当前月天数小于左边的:month:"+month+",day:"+day);
        }else{
            month = month-1;
        }
        Log.e("calendar","setLeftDate:day:"+day);
...
//            day = DateUtils.getMonthDays(year, month);
        ...
        Log.e("calendar","setRightDate:day:"+day);
        setSelectDate(year,month,day);
        computeDate();
    }
