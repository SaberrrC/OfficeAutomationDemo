...
public class CircleMonthView extends MonthView {
    ...
    protected void drawBG(Canvas canvas, int column, int row, int day) {
        if(day == selDay){
//            Log.e("calendar","day == selDay->drawBG:day"+day+",selDay:"+selDay);
            //绘制背景色矩形
            ...
            //绘制背景圆的大小
            float radius = columnSize < rowSize ? columnSize / 4 : rowSize / 4;
...
//            float circleY = (float) (rowSize * row + rowSize*0.2);
            ...
            float circleY = (float) (rowSize * row + rowSize*0.8);
...
//        Log.e("calendar","CircleMonthView->drawBG:day"+day+",month:"+month);
...
//            Log.e("calendar","CircleMonthView->drawBG:day"+day+",month:"+month);
            ...
            Log.e("CircleMonthView->","year:"+year+"month:"+month+",day:"+day);
            Log.e("CircleMonthView->","currMonth:"+currMonth+"currDay:"+currDay);
            //今日的颜色，不是选中的时候
            //正常月，选中其他日期，则今日为红色
