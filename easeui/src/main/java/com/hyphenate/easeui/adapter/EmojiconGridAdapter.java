    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(EaseSmileUtils.DELETE_KEY.equals(emojicon.getEmojiText())){
            ...
            if(emojicon.getIcon() != 0){
                ...
                Glide.with(getContext()).load(emojicon.getIconPath()).dontAnimate().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.ease_default_expression).into(imageView);
            }
        }
