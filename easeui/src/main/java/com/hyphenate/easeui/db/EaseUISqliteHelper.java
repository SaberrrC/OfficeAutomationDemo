...
public class EaseUISqliteHelper extends SQLiteOpenHelper {
    ...
    private void createTable(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + FriendsInfoCacheSvc.TABLE_NAME + " (id integer PRIMARY KEY," +
                "user_id text collate nocase,nickname text,portrait text,userSex text,userPhone text,userPost text,userDepartment text,userEmail text,userDepartmentId text)");
