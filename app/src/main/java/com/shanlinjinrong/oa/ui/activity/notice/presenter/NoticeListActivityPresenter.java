 ...
 * 消息通知列表presenter
 */
public class NoticeListActivityPresenter extends HttpPresenter<NoticeListActivityContract.View> implements NoticeListActivityContract.Presenter {

    @Inject
    public NoticeListActivityPresenter(MyKjHttp mKjHttp) {
        super(mKjHttp);
    }
