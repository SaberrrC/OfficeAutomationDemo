...
public class WorkReportBean {
    ...
    private String selfRatingEigth;// 自评17-17:30
    private String selfRatingFive;// 自评14-15
    private String selfRatingFour;// 自评13-14
    private String selfRatingOne;//	自评9-10
    private String selfRatingSeven;//	自评16-17
    private String selfRatingSix;//	自评15-16
    private String selfRatingThree;// 自评11-12
    private String selfRatingTwo;//	自评10-11
    ...
    private String workFive;//	实际工作14-15
    private String workFour;//	实际工作13-14
    private String workOne;//	实际工作9-10
    private String workPlanEigth;//	计划工作17-17:30
    private String workPlanFive;//	计划工作14-15
    private String workPlanFour;//	计划工作13-14
    private String workPlanOne;//	计划工作9-10
    private String workPlanSeven;//	计划工作16-17
    private String workPlanSix;//	计划工作15-16
    private String workPlanThree;//	计划工作11-12
    private String workPlanTwo;//	计划工作10-11
    private String workSeven;//	实际工作16-17
    private String workSix;//	实际工作15-16
    ...
    public WorkReportBean setSupervisor(String supervisor) {
    ...
    public WorkReportBean setSupervisorId(String supervisorId) {
    ...
    public WorkReportBean setTime(String time) {
        this.time = time;
        return this;
    }
