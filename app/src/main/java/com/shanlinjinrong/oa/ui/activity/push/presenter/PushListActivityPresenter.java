 ...
 * PushListActivityPresenter
 */
public class PushListActivityPresenter extends HttpPresenter<PushListActivityContract.View> implements PushListActivityContract.Presenter {

    @Inject
    public PushListActivityPresenter(MyKjHttp mKjHttp) {
        super(mKjHttp);
    }
