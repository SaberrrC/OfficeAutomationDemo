...
/**
 * 概述：
 * Created by KevinMeng on 2016/5/24.
 */
public class ProgressWheel extends View {
  ...
  public ProgressWheel(Context context, AttributeSet attrs) {
    ...
    parseAttributes(context.obtainStyledAttributes(attrs,
            com.shanlinjinrong.oa.R.styleable.ProgressWheel));
  ...
  private void setupBounds(int layout_width, int layout_height) {
    ...
    if (!fillRadius) {
      // Width should equal to Height, find the min value to setup the circle_red
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(
                com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_circleRadius,
                circleRadius);

    fillRadius = a.getBoolean(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_fillRadius, false);

    barWidth = (int) a.getDimension(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_barWidth,
            barWidth);

    rimWidth = (int) a.getDimension(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_rimWidth,
            rimWidth);

    float baseSpinSpeed = a.getFloat(
                com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_spinSpeed,
            spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime = a.getInt(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_barSpinCycleTime,
            (int) barSpinCycleTime);

    barColor = a.getColor(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_barColor,
            barColor);

    rimColor = a.getColor(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_rimColor,
            rimColor);

    linearProgress = a.getBoolean(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_linearProgress,
            false);

    if (a.getBoolean(
            com.shanlinjinrong.oa.R.styleable.ProgressWheel_matProg_progressIndeterminate, false)) {
      spin();
    }
  ...
  /**
   * @return the base spinning speed, in full circle_red turns per second
  ...
  /**
   * Sets the base spinning speed, in full circle_red turns per second
   * (1.0 equals on full turn in one second), this value also is applied for
   * the smoothness when devices a progress
   *
