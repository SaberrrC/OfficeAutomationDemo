...
//		demoHelper.getInstance().isVoiceCalling = true;
        ...
        LogUtils.e("getIntent().getStringExtra->" + nike + "," + isInComingCall);


        String sideInfoNike = AppConfig.getAppConfig(this).get(AppConfig.PREF_KEY_USERNAME);
        String sideInfoPortrait = AppConfig.getAppConfig(this).get(AppConfig.PREF_KEY_PORTRAITS);
        sideInfo = sideInfoNike + "&" + sideInfoPortrait;
